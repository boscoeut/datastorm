...
#### By Phase
- `tasks/phase-1/` - Core Vehicle Database tasks
- `tasks/phase-2/` - Comparison and Market Data tasks
- `tasks/phase-3/` - News and Search tasks
- `tasks/phase-4/` - Visualization and Polish tasks
...
4. **Align with priorities** - follow the established priority order
5. **Validate scope** - ensure task fits 4-hour constraint

### After Completing a Task
1. **Update task status** in your task file
2. **Update taskList.md** to mark task as completed
3. **Update project status** and milestone progress
...
- **Before new tasks**: Verify alignment with current project state
