...
const mockGeminiResponse: GeminiArticleResponse[] = [
  {
    ...
    summary: "Tesla has unveiled a breakthrough battery technology that promises 500-mile range on a single charge.",
    category: "Technology",
    tags: ["tesla", "battery", "technology", "range"]
  },
  {
    title: "Tesla Model Y Production Hits Record Numbers",
    summary: "Tesla's Model Y production has reached unprecedented levels, setting new industry benchmarks.",
