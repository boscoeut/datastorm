...
show_usage() {
    ...
    echo "  Tesla News Fetcher: {}"
    echo "  Vehicle Database Populator: {\"action\":\"populate\"}"
    echo ""
    echo "Note: When passing JSON data, ensure proper escaping:"
    echo "  Use: $0 vehicle-database-populator 8000 '{\"action\":\"populate\"}'"
    echo "  Or: $0 vehicle-database-populator 8000 '{\"action\":\"populate\",\"limit\":5}'"
    echo ""
}
